...
const userController = {
  async sendSignupOtpToEmail(req, res, next) {
    ...
    return res
      .status(200)
      .send(dataResponse("Sign up Otp has been sent to email"));
  },
  ...
  async verifySignUpEmail(req, res, next) {
    ...
    return res
      .status(200)
      .send(dataResponse("Email has been verified successfully"));
  },
  ...
  async sendSignupOtpToPhone(req, res, next) {
    ...
    return res
      .status(200)
      .send(dataResponse("Sign up Otp has been sent to Phone", resBody));
  },
  ...
  async verifySignUpPhone(req, res, next) {
    ...
    return res
      .status(200)
      .send(dataResponse("Phone Number has been verified successfully"));
  },
  ...
  async registerAccount(req, res, next) {
    ...
    let resBody = await userServices.registerAccount(
      emailCredentialsToken,
      phoneCredentialsToken,
      firstName,
      lastName,
    ...
    return res
      .status(201)
      .send(dataResponse("Account has been created", resBody));
  },
  ...
  async createPassword(req, res, next) {
    ...
    return res
      .status(201)
      .send(dataResponse("New password has been created", resBody));
  },
  ...
  async sendForgotPasswordOtpToEmail(req, res, next) {
    ...
    return res
      .status(200)
      .send(dataResponse("Otp has been successfully sent to your email"));
  },
  ...
  async verifyForgotPasswordEmail(req, res, next) {
    ...
    return res
      ...
      .send(
        dataResponse(
          "Email has been verified successfully for Reset Password",
          resBody
        )
      );
  },
  ...
  async signInAccount(req, res, next) {
    ...
    return res
      .status(201)
      .send(dataResponse("You have successfully logged in", resBody));
  },

  async registerPetOwnerAccount(req, res, next) {
    let { email, phone, firstName, lastName, dob, address, location } =
      req.body;

    let resBody = await userServices.registerPetOwnerAccount(
      email,
      phone,
      firstName,
      lastName,
  ...
  async registerUserAccount(req, res, next) {
    let { email, phone, firstName, lastName, dob, location } = req.body;

    let resBody = await userServices.registerUserAccount(
      email,
      phone,
      firstName,
      lastName,
  ...
  async getMyProfile(req, res, next) {
    ...
    return res
      .status(200)
      .send(dataResponse("Profile has been retrieved successfully", resBody));
  },

  async verifyGoogleToken(req, res, next) {
    let { idToken } = req.body;

    let { message, resBody } = await thirdPartyAuthServices.verifyGoogleToken(
      idToken
    );
