  ...
  return `
      <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif; border: 1px solid #ddd; border-radius: 10px;">
        <div style="text-align: center;">
          <img src="https://firebasestorage.googleapis.com/v0/b/bondly-app-d7112.appspot.com/o/cover%2Flogos%2Flogo.png?alt=media&token=108f59a8-fc64-49e8-994b-e31166a4053f" alt="${process.env.APP_NAME}" style="width: 100px; margin-bottom: 20px;" />
        </div>
